...
class AlignBoard(smach.State):
    ...
    # completeArea = 68000
    completeArea = 60000        # US Small pool

    # deltaXMult = 4.9
    deltaXMult = 2.50   # US Small Pool
    # deltaYMult = 1.6
    deltaYMult = 1.0    # US Small Pool
    headingMult = 1.5
    ...
    def execute(self, ud):
        ...
        if self.comms.boardArea < self.halfCompleteArea:
            ...
            self.forward_setpoint = 0.5     # US Small pool 1
...
class Centering (smach.State):
    ...
    # completeRadius = 91
    completeRadius = 86     # US Small pool
    # completeRadius = 76       # US Tech Tank
    forward_half = 0.23
    ...
    def execute(self, userdata):
        ...
        if self.comms.numShoot == 1:
            ...
            self.completeRadius = 73    # US Tech Tank
            # self.completeRadius = 78  # US House 1
