...
class TorpedoVision:    
    ...
    greenParams = {
                    ...
                    'lo': (100, 0, 145), 'hi': (230, 103, 255), # Lab params to try
    ...
    def gotFrame (self, img):        
                ...
                for cont in circleCont:
                    if cv2.contourArea(cont) > 100:
                        ...
                        if radius > 20:
                            ...
                            dist = abs(cx-self.aimingCentroid[0])
        ...
        #     allCentroidList = sorted(allCentroidList, key=lambda centroid:centroid[3], reverse=True)
        # else:
        #     allCentroidList = sorted(allCentroidList, key=lambda centroid:centroid[2], reverse=True)
